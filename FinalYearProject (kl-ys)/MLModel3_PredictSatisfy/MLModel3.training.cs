    ...
    public partial class MLModel3
    {
        ...
        public static IEstimator<ITransformer> BuildPipeline(MLContext mlContext)
        {
            ...
            var pipeline = mlContext.Transforms.ReplaceMissingValues(new []{new InputOutputColumnPair(@"Company culture", @"Company culture"),new InputOutputColumnPair(@"Job satisfaction", @"Job satisfaction"),new InputOutputColumnPair(@"Professional growth", @"Professional growth"),new InputOutputColumnPair(@"Manager relationship", @"Manager relationship"),new InputOutputColumnPair(@"Compensation and benefits", @"Compensation and benefits"),new InputOutputColumnPair(@"Work-life balance", @"Work-life balance")})      
                                    ...
                                    .Append(mlContext.Transforms.Conversion.MapValueToKey(outputColumnName:@"Satisfy?",inputColumnName:@"Satisfy?"))      
                                    .Append(mlContext.MulticlassClassification.Trainers.LightGbm(new LightGbmMulticlassTrainer.Options(){NumberOfLeaves=4,NumberOfIterations=4,MinimumExampleCountPerLeaf=20,LearningRate=1,LabelColumnName=@"Satisfy?",FeatureColumnName=@"Features",ExampleWeightColumnName=null,Booster=new GradientBooster.Options(){SubsampleFraction=1,FeatureFraction=1,L1Regularization=2E-10,L2Regularization=1},MaximumBinCountPerFeature=255}))      
