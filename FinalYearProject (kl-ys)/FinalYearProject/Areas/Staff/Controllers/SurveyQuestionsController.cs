            ...
            string[] selectedQuestions, string survey_id, string survey_name, string company_id)
        {
            ...
            foreach (var entry in selectedQuestionTypeCounts)
            {
                ...
                if (count < 3)
                {
                    ...
                    return RedirectToAction(nameof(Index), new { area = "Admin", controller = "SurveyQuestions", survey_id, survey_name, company_id });
                }
            }
            ...
            return RedirectToAction(nameof(ViewOwnSurveyQuestion), new { area = "Admin", controller = "SurveyQuestions", survey_id });
