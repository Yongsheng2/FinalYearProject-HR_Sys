...
{
    /// <summary>
    /// model input class for MLModel4.
    /// </summary>
    ...
    /// <summary>
    /// model output class for MLModel4.
    /// </summary>
    ...
    public class ModelOutput
    {
        ...
        public IDictionary<string, float> Probabilities { get; set; }

    }

    #endregion

    private static string MLNetModelPath = Path.GetFullPath("MLModel4.zip");
