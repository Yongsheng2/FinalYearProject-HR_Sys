...
namespace FinalYearProject.Areas.Staff.Controllers
{
    ...
    public class RatingController : Controller
    {
        ...
        {
            var empSelected = await _db.EmployeeDetails.Where(e => e.employee_id == id).FirstOrDefaultAsync();
        ...
        public async Task<IActionResult> ViewOwn()
        {
            ...
            {
                var empSelected = await _db.EmployeeDetails.Where(e => e.user_id == aspId).FirstOrDefaultAsync();
        ...
        public async Task<IActionResult> Create(string id)
        {
            ...
            else
            {
                ...
                else
                {
                    ...
                    var rating = await _db.Rating.Where(r => r.rated_by == currentUser.employee_id && r.staff_rated == rated.employee_id 
                                && r.rate_date.Value.Month == DateTime.Now.Month ).FirstOrDefaultAsync();
